...
> 1. **Paso 0:** léete el ejercicio y ten a mano OBS y tu identificación. **Crea la entrada de apuntes de esta práctica** en Obsidian: fichero `b1-7-kit-multiboot-con-ventoy.md` dentro de `00_Apuntes/Trimestre_N/B1_Entorno/`, con la estructura de la Fase 0.1 y **vacía**. Rellenarla es cosa tuya, después.
...
- **Entregable vídeo:** `B1.7 · Kit multiboot con Ventoy` en `B1_Entorno`. **Una sola entrega.**
