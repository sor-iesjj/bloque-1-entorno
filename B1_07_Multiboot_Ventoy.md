...
> 4. **Al terminar:** nombra el vídeo **`B1.7 · Kit multiboot con Ventoy`** y súbelo a **`B1_Entorno`** (No listado). Y **pega su enlace dentro de tu entrada de apuntes**, en el apartado `🔗 Enlaces`.
