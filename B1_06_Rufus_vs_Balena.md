...
> 4. **Al terminar:** nombra el vídeo **`B1.6 · Comparativa Rufus vs Balena Etcher`** y súbelo a **`B1_Entorno`** (No listado).
> 5. **Una sola entrega.**
...
- **Entregable vídeo:** `B1.6 · Comparativa Rufus vs Balena Etcher` en `B1_Entorno`. **Una sola entrega.**
