...
> 4. **Al terminar:** nombra el vídeo **`B1.4 · Descargar y verificar la ISO (SHA256)`** y súbelo a **`B1_Entorno`** (No listado).
> 5. **Una sola entrega.**
...
- **Entregable vídeo:** `B1.4 · Descargar y verificar la ISO (SHA256)` en `B1_Entorno`. **Una sola entrega.**
