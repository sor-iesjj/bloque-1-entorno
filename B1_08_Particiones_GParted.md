...
> 4. **Al terminar:** nombra el vídeo **`B1.8 · Particiones MBR/GPT con GParted`** y súbelo a **`B1_Entorno`** (No listado). Y **pega su enlace dentro de tu entrada de apuntes**, en el apartado `🔗 Enlaces`.
